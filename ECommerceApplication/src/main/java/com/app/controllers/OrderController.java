...
public class OrderController {
	...
	@PostMapping("/public/users/{email}/carts/{cartId}/banktransfer/order")
	public ResponseEntity<OrderDTO> orderBankTransfer(
			@PathVariable String email,
			@PathVariable Long cartId,
			@RequestParam String bankName) {
		OrderDTO order = orderService.placeBankTransferOrder(email, cartId, bankName);
